...
irq
    ...
    inc position_index
    ldx position_index
    lda sinus_y,x   ;; update sprite x/y from sinus tables
    sta $d001
    clc             ;; clear carry
    lda #offset     ;; calculate x value based on fixed offset and sinus table
    adc sinus_x,x
    bcs set_msb       ;; branch when carry is set
    sta $d000
    lda $d010       ;; x <= 255, clear msb
    and #%11111110
    sta $d010
    jmp $ea81       ;; exit
set_msb
    sta $d000       ;; x > 255, set sprite 0 msb bit
    lda $d010
    ora #%00000001
    sta $d010
    jmp $ea81
